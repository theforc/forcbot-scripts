...
module.exports = (robot) ->
  robot.hear /(minimalist|absence of clutter|aluminium|essential|elegant|efficient|experience|incredible|magical|meticulous|unibody|from the ground up)/i, (msg) ->
